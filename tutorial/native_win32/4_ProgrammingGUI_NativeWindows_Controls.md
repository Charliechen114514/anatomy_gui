...
另一个现实原因是：现代框架像 WPF、GTK 把控件封装得太好了，你可能从来不需要关心 WM_COMMAND 是什么。但一旦你需要做一些底层优化，或者遇到了框架无法解决的 bug，这些知识就会成为你的救命稻草。而且，理解了 Win32 的控件机制之后，再去学其他框架的控件系统，你会发现很多东西都是相通的。
